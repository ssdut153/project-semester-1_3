...
ExpreessionWindow::ExpreessionWindow(ChatWindow *parent) :
    QMainWindow(parent),
...
void ExpreessionWindow::on_comfirmButton_clicked(){
    ...
    chatwindow->setExpreessionWindow(0);
    delete this;
}

void ExpreessionWindow::on_cancelButton_clicked(){
    chatwindow->setExpreessionWindow(0);
    delete this;
}
